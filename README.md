...
## 🏁 Progresso Atual: Lição 15 / 19

---

## 📑 Conteúdos Consolidados

Até o momento, os seguintes tópicos foram estudados e praticados através dos desafios da plataforma:
...
* [x] [SQL Lesson 10 & 11: Queries with aggregates](https://sqlbolt.com/lesson/select_queries_with_aggregates) 
* [x] [**SQL Lesson 12: Order of execution of a Query**](https://sqlbolt.com/lesson/select_queries_order_of_execution) 👈 *Atual*
